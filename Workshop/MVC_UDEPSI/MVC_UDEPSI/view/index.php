...
<body>
    <div class="container-fluid">    
        <button class="top_button" onclick="topFunction()" id="btn_top" title="Go to top">
            <img class="top_arrow" src="../html/arrow.svg">
        </button>
        <div class="row strip">
            ...
            <div class="col-3" style="padding:0px">
                <div class="row strip">
                    ...
                    <div class="col-10 connexion">
                        ...
                        <a href="index.php">
                            <img src="../html/hayden.jpg" class="pp"/>
                            ...
                            <form action="action_page.php" class="form">
                                ...
                                <div class="others">
                                    ...
                                    <button type="submit" class="submit">
                                        <img class="magnifier" src="../html/search.svg"/>
                                    </button>
                ...
                <div class="row strip">
                    ...
                    <div class="col-7 udepsi_strip">
                        <a href = "index.php" class="mainpagebutton">
                            <img class="udepsi_logo" src="../html/logo.png" alt"logo epsi"/>
                            <img class="epsi_logo" src="../html/epsi_l.png" alt="logo epsi"/>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row main" style="margin-left=1vw !important">
            <div id="test" class="col-12" style="text-align: center">
                <div class="content-main">
                    <div class="course">
                        <img class="course-tech" src="../html/php.pn"/>
                    ...
                    <div class="course">
                        <img class="course-tech" src="../html/cs.png"/>
                        <div class="course-title">
                    ...
                    <div class="course">
                        <img class="course-tech" src="../html/php.png"/>
                        <div class="course-title">
                            Titre du cours
                        </div>
                        <div class="course-bottom">
